export default {
    ...
    config: {
        ...
        webdav: {
            ...
            errors: { testFailed: "WebDAV connection test failed", downloadFailed: "Failed to read the WebDAV sync file", downloadTimeout: "Timed out while reading the WebDAV sync file", emptyUpload: "The upload file is empty; upload canceled", uploadFailed: "Failed to upload the WebDAV sync file", deleteFailed: "Failed to delete the remote WebDAV file", unsafePath: "The WebDAV remote file path is unsafe; operation canceled", directoryFailed: "Failed to create the remote WebDAV directory", requestTimeout: "The WebDAV request timed out. Check the network or remote service.", connectionFailed: "Could not connect to WebDAV. Check the address, HTTPS certificate, CORS, and network.", urlRequired: "Enter a WebDAV URL first", authenticationFailed: "WebDAV authentication failed. Check the username, password, or app password.", pathMissing: "The WebDAV path does not exist. Check the address and remote directory.", responseFailed: "{{fallback}}: {{status}}{{detail}}", syncFailed: "Sync failed", invalidManifest: "The {{domain}} sync manifest does not belong to this app", trashNotFound: "No recoverable trash record was found", trashPersistFailed: "Failed to persist the sync trash record" },
            trash: { title: "Remote trash", refresh: "Refresh trash", restore: "Restore", clear: "Clear trash", empty: "Trash is empty", loadFailed: "Failed to load trash", restoreSuccess: "Restored successfully", restoreFailed: "Restore failed", clearSuccess: "Trash cleared", clearFailed: "Failed to clear trash", clearConfirmTitle: "Clear trash?", clearConfirmContent: "This permanently deletes all remote trash records and their associated files. This action cannot be undone." },
        },
        protocols: {
            ark: "Volcengine Ark",
        },
